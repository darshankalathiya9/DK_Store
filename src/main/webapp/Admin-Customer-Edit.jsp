				...
				<nav
					...
					<div class="scrollbar scrollbar1">
						<ul class="nav" id="side-menu">
							...
							<li><a href="Admin-Customer-List.jsp" class="active"><i
							...
							<div class=" form-grids form-grids-right">
								<div class="widget-shadow " data-example-id="basic-forms">
									<div class="form-title">
										<h4 class="text-center"><%=c.getUsername()%>'s Edit Profile</h4>
									</div>
									<div class="form-body">
										...
										<form class="form-horizontal" action="CustomerController" method="post">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" class="form-control" name="Username" value="<%=c.getUsername()%>">
												</div>
											</div><br>
											<div class="form-group">
