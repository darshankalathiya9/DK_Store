				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Become a Seller<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<li><a href="Seller-Registration.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Seller Register</a></li>
												<li><a href="Seller-Login.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Seller Login</a></li>
											</ul>
										</div>
										<div class="clearfix"></div>
									</div>	
...
<div class="banner-top">
	<div class="container">
		<h3 >Login</h3>
		<h4><a href="Index.jsp">Home</a><label>/</label> Customer-Login</h4>
		<div class="clearfix"></div>
	</div>
</div>
...
<!--login-->
	<div class="login">
		<div class="main-agileits">
				...
				<div class="forg">
					<a href="Customer-Forgot-Password.jsp" class="forg-left">Forgot Password</a>
					<a href="Customer-Registration.jsp" class="forg-right">Register</a>
				<div class="clearfix"></div>
				</div>
			</div>
		</div>
