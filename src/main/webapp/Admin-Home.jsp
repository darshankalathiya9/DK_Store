...
<body class="cbp-spmenu-push">
	...
	<!-- Bootstrap Core JavaScript --> 
		...
		<!-- candlestick -->
		<script type="text/javascript" src="Admin/js/jquery.jqcandlestick.min.js"></script>
		<link rel="stylesheet" type="text/css" href="Admin/css/jqcandlestick.css" />
		<!-- //candlestick -->
		...
		<!-- real-time-updates -->
		<script language="javascript" type="text/javascript" src="Admin/js/jquery.flot.js"></script>
		<script type="text/javascript">
		...
		<!-- //real-time-updates -->
		<!-- error-graph -->
		<script language="javascript" type="text/javascript" src="Admin/js/jquery.flot.errorbars.js"></script>
		<script language="javascript" type="text/javascript" src="Admin/js/jquery.flot.navigate.js"></script>
		<script type="text/javascript">
			$(function() {
