...
<script type="text/javascript">
	...
	function CreateOrderID()
	{
		...
		xhttp.open("GET","http://localhost:8080/Bootie/OrderCreation?amount="+number,false);
		/* alert("2"); */
		xhttp.send();
...
<script type="text/javascript">
	function OpenCheckOut()
	{
		...
		var options={
				...
				"callback_url":"http://localhost:8080/Bootie/Customer-Home.jsp",
				"prefill":{
					"name":"Darshan Kalathiya",
					"email":"darshankalathiya963@gmail.com",
					"contact":"9624360699"
				},
				"notes":{
					"address":"Bhavnagar"
