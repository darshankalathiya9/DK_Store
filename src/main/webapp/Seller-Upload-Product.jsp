				...
				<div class="form-w3agile form1">
					<form action="ProductController" method="post" enctype="multipart/form-data">
						...
						<div class="key">
							...
							<input  type="text" value="Product Name" name="PName" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Name';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-inr" aria-hidden="true"></i>
							<input  type="text" value="Product Price" name="PPrice" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Price';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-font" aria-hidden="true"></i>
							<input  type="text" value="Product Category" name="PCategory" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Category';}" required="">
							<div class="clearfix"></div>
						</div>
						<div class="key">
							<i class="fa fa-font" aria-hidden="true"></i>
							<input  type="text" value="Product Description" name="PDesc" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Product Description';}" required="">
							<div class="clearfix"></div>
						</div>
